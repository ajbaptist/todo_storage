            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ListTile(
                          ...
                          leading: Checkbox(value: check, onChanged: (value){todoController.changeCheckList(index, value);}),
                        
                          trailing: IconButton(onPressed: (() => todoController.removeTodo(index)), icon: Icon(Icons.delete,color: Colors.red,)),
                        ),
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text("Location :$location",style: TextStyle(fontWeight: FontWeight.bold),),
                  ),
                ],
              ),
            );
                      ...
                      children: [
                       ...
                       TextField(
                        ...
                        TextButton(
                          ...
                          onPressed: () {
                            todoController.addTodo(todoController.textEditingController.text);
